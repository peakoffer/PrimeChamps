...
- Social Blade is the next measured pilot. All 17 known positive cutoffs fall between 2025-08-21 and 2026-08-05, so the official API needs at most 34 credits for all records; start with five records and a hard ten-credit ceiling, then audit actual match/readiness gain before continuing.
