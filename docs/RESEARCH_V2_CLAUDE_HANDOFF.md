...
- The corrected audit reads evidence claims in bounded batches instead of silently stopping at Supabase's default 1,000-row response cap. It currently finds 30 total evidence-ready records.
- Existing assignments are 16 development records, 16 already-revealed held-out records, and 68 fresh excluded records. Of the fresh excluded pool, one positive and all 16 required negatives are evidence-ready.
- The fresh cohort route requires 16 evidence-ready records per label before it can freeze eight fresh held-out examples per label. The immediate gap is therefore 15 excluded positives and zero excluded negatives.
...
- The final three-record negative recovery run `7f507de9-7d8e-47ff-870b-9a37629bb64e` processed Murat Kazgan, Christen Press, and Sadio Doumbia for $0.0185, zero scoring tokens, and zero live writes. All three became evidence-ready. The global audit now reads 30 ready cases, 1,289 safe claims, 907 sources, 100/100 point-in-time compliance, and fresh excluded readiness of `1 fit / 16 not-fit`. Stop negative recovery; that cohort side is complete.
...
- Reach at least 16 evidence-ready excluded positives and 16 evidence-ready excluded negatives. Current state is `1 positive / 16 negative`, so the only remaining gap is `15 positive / 0 negative`.
