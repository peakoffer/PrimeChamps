...
The production benchmark UI currently exposes 28 fresh, labeled, never-scored records: nine positive and 19 negative. Eight negatives and three positives are evidence-ready, so the fresh 8+8 challenge cannot be frozen yet. Within Dylan's new eight-signed-athlete cohort, seven pass identity, seven pass corroborated 21+, all eight pass momentum and creator behavior, but only three have cutoff-safe audience evidence. These live counts supersede the older recovery counts retained below as chronology.
