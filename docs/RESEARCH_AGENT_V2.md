...
- The corrected readiness audit reads all evidence in bounded batches and now finds 27/100 freeze-ready cases. The fresh excluded pool is `1 fit / 13 not-fit` ready. A new cohort requires `16/16`; targeted evidence recovery remains the next dependency.
