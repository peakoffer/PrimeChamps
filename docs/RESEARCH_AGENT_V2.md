...
- The next discovery proof uses a sport-agnostic creator-first second wave. It must find candidates through current creator/NIL/personal-brand/audience evidence and separately verify professional status; roster-only names are excluded from that lane. This is intended to increase fresh 30K-500K audience yield without changing the finalist score or evidence gates.
