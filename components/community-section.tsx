        ...
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-4xl md:text-5xl font-bold mb-8 tracking-tighter">
            ...
            <span className="gradient-text">
              <TypeAnimation
                sequence={["Champions", 2000, "Creators", 2000, "Innovators", 2000, "Game Changers", 2000]}
                wrapper="span"
                speed={50}
          ...
          <p className="text-xl text-muted-foreground leading-relaxed mb-12">
            Collaborating with a vibrant community of rising stars who are shaping the future of sports culture. Our
            network drives every partnership, every campaign, and every success story.
          </p>
