  ...
  return (
    <>
      <section className="min-h-screen flex items-center justify-center bg-gradient-to-br from-background via-background to-accent/5">
        <motion.div 
          className="text-center px-4 max-w-4xl mx-auto space-y-8"
          variants={container}
          initial="hidden"
          animate="show"
        >
          ...
          <motion.p 
            variants={item}
            className="text-xl md:text-2xl mb-12 text-muted-foreground leading-relaxed"
          >
            We bridge the gap between athletes and brands, creating lucrative partnerships 
            that elevate both your influence and income.
          </motion.p>
